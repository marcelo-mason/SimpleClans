...
//        alliancesCommand = new AlliancesCommand(plugin);
...
//                String[] subargs = Helper.removeFirst(args);
            plugin.getBetaCommandManager().executeAll(player, null, "clan", "clan", args);
...
//                }
//                if (subcommand.equalsIgnoreCase(plugin.getLang("rally.command"))) {
//                    rallyCommand.execute(player, subargs);
...
//                    alliancesCommand.execute(player, null, subargs);
